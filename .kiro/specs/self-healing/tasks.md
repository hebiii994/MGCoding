...
- [x] 1. Fondamenta: Config_Key, comando e tipi di dominio
  - [x] 1.1 Dichiarare Config_Key, comando e tipi condivisi
...
- [x] 2. Issue model e report (nucleo puro)
  - [x] 2.1 Implementare dedup, report e classificazione della proposta
  ...
  - [x] 2.2 Property test per la dedup delle Issue
  ...
  - [x] 2.3 Property test per l'Issue_Report
  ...
  - [x] 2.4 Property test per la classificazione della proposta
...
- [x] 3. Verification_Gate (nucleo puro per il confronto)
  - [x] 3.1 Implementare il confronto degli snapshot di verifica
  ...
  - [x] 3.2 Property test per il verdetto di regressione
    - File `extensions/mgcoding/src/test/verificationCompare.pbt.test.ts`
    - **Property 4: Semantica del verdetto di regressione**
    - **Validates: Requirements 6.2, 6.3**

- [x] 4. Reward_Hacking_Guard (nucleo puro)
  - [x] 4.1 Implementare i guardrail anti-imbroglio
  ...
  - [x] 4.2 Property test per i Protected_Path
  ...
  - [x] 4.3 Property test per la riduzione del numero di test
...
- [x] 5. Budget dei tentativi (nucleo puro)
  - [x] 5.1 Implementare la decisione sui tentativi
  ...
  - [x] 5.2 Property test per il budget dei tentativi
...
- [x] 6. Checkpoint - Verifica dei nuclei puri
  - Ensure all tests pass, ask the user if questions arise.
  - Verificato: suite completa verde (72/72 file, `npm test`), inclusi i 7 property test dei nuclei.
