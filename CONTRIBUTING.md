...
MGCoding è un fork di [Visual Studio Code / Code-OSS](https://github.com/microsoft/vscode) (Microsoft, licenza MIT) ispirato a [Kiro](https://kiro.dev). Per problemi che riguardano il *core* dell'editor (non specifici di MGCoding) la documentazione e gli issue di VS Code restano un riferimento utile.
